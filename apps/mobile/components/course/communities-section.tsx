...
function WhatsAppIcon() {
  return (
    <Svg width={20} height={20} viewBox="0 0 24 24" fill="#5b7a5e">
...
function InstagramIcon() {
  return (
    <Svg width={20} height={20} viewBox="0 0 24 24" fill="#c47a5a">
    ...
    <View style={{ marginTop: 32, borderRadius: 16, overflow: "hidden" }}>
      ...
      >
        ...
        <View style={{ width: "100%", gap: 10 }}>
          ...
          >
            <WhatsAppIcon />
            <Text style={{ fontSize: 13, fontWeight: "600", color: "#5b7a5e" }}>
          ...
          >
            <InstagramIcon />
            <Text style={{ fontSize: 13, fontWeight: "600", color: "#c47a5a" }}>
