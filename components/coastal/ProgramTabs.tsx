...
const ROWS = {
  self: [
    ["Recorded introduction", "A short, self-paced taste of how we teach — credits toward a cohort.", "₹999"],
    ["Free recorded masterclass", "One full session, free. No card required.", "Free"],
    ["Worksheet & tool pack", "Downloadable exercises you can use today.", "Free"],
  ],
  therapy: [
    ["One calm conversation", "A single session with a licensed professional. No commitment.", "₹600"],
    ["Ongoing counselling", "A steadier rhythm of support, booked session by session.", "Enquire"],
    ["Supervision for practitioners", "Structured supervision and peer community for practising therapists.", "Enquire"],
  ],
} as const;
          ...
          {LIVE.map((c) => (
            ...
            >
              ...
              <div className="flex flex-1 flex-col gap-2 p-6">
                <h3 className="font-display text-xl leading-snug">{c.name}</h3>
