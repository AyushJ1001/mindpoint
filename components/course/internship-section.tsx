      ...
      <div className="mb-8 space-y-3">
        {allocation.map((item, index) => (
          <div key={index} className="flex items-center justify-between py-2">
            ...
            <span className="mx-3 flex-1 border-b border-dotted border-border"></span>
          ...
          <div className="mx-auto max-w-4xl space-y-8">
            ...
            <div
              className={`relative cursor-pointer rounded-3xl border-2 p-8 shadow-xl transition-all duration-300 ${
                selectedHours === 120
                  ? "border-primary bg-secondary/50 shadow-2xl"
                  : "border-border bg-white hover:shadow-2xl"
              }`}
        ...
        <div className="mb-16">
          ...
          <div className="mx-auto max-w-4xl space-y-8">
            ...
            >
              ...
              <div className="rounded-xl border border-border bg-gradient-to-r from-secondary to-cream-50 p-6">
            ...
            >
              ...
              <div className="rounded-xl border border-border bg-gradient-to-r from-cream-50 to-secondary p-6">
                <h4 className="mb-3 text-center font-bold text-foreground">
                  Advanced Level
                </h4>
                <p className="text-center text-sm leading-relaxed text-muted-foreground">
